  ...
  return (
    <div className="flex flex-col h-full bg-[#FAFAFC] font-sans pb-20 overflow-y-auto">
      ...
      <div className="px-6 py-10 bg-white shadow-sm border-b border-gray-100">
        ...
        {/* Token Balance */}
        <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100/50 rounded-xl">
           <div className="flex items-center justify-between">
             ...
             <button 
               ...
               className="bg-[#3182f6] hover:bg-blue-600 text-white text-sm font-bold py-2 px-4 rounded-xl shadow-sm transition-colors active:scale-95"
             >
               충전하기
             </button>
           </div>
      ...
      {/* Shop Modal */}
      {showShop && <ShopContainer onClose={() => setShowShop(false)} />}
    </div>
  );
}
